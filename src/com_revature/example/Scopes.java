...
public class Scopes 
{
	...
	/*
	 * this is a variable that all instances will have in the instance
	 * scope
	 ...
	 * "this" prepended to the variable name allows us to reference the
	...
	public static void main(String[] args) 
	{
		...
		System.out.println(s.variable2); //variable2 is defined for an INSTANCE of 
